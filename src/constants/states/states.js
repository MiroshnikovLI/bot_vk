const STATES = {
  ...
  WAITING_WB_ID_REPLACEMENT: "waitingWbIdReplacement",
  WAITING_FULL_NAME_REPLACEMENT: "waitingFullNameReplacement",
  WAITING_NUMBER_REPLACEMENT: "waitingNumberReplacement",
}
