  ...
  const buttons = [
    [
      ...
      },
      {
        action: {
          type: `text`,
          label: `✏️ ${COMMANDS.EDIT_DATA.toUpperCase()}`,
        },
        color: `secondary`,
      },
    ],
    [
      {
        action: {
          type: `text`,
          label: `🏪 ${COMMANDS.UNSUBSCRIBE_SETTINGS.toUpperCase()}`,
        },
        color: `secondary`,
      },
    ],
    ...
    [
      ...
      },
      {
        action: {
          type: `text`,
          label: `🌙 ${COMMANDS.CLOSE_PVZ.toUpperCase()}`,
        },
        color: `primary`,
      },
    ],
...
function getUnsubscribeKeyboard() {
  return {
    buttons: [
      [
        {
          action: {
            type: `text`,
            label: `➕ ${COMMANDS.ADD_PVZ.toUpperCase()}`,
          },
          color: `secondary`,
        },
        {
          action: {
            type: `text`,
            label: `🗑️ ${COMMANDS.DELETE_PVZ.toUpperCase()}`,
          },
          color: `negative`,
        },
      ],
      [
        {
          action: {
            type: `text`,
            label: `➕ ${COMMANDS.ADD_REPLACEMENT.toUpperCase()}`,
          },
          color: `secondary`,
        },
        {
          action: {
            type: `text`,
            label: `🗑️ ${COMMANDS.DELETE_REPLACEMENT.toUpperCase()}`,
          },
          color: `negative`,
        },
      ],
      [
        {
          action: { type: `text`, label: `🔙 ${COMMANDS.BACK.toUpperCase()}` },
          color: `primary`,
        },
      ],
    ],
      ...
      [
        {
          action: {
            type: `text`,
            label: `✏️ ${COMMANDS.CHANGE_NAME.toUpperCase()}`,
          },
          color: `secondary`,
        },
        {
          action: {
            type: `text`,
            label: `✏️ ${COMMANDS.CHANGE_WB_ID.toUpperCase()}`,
          },
          color: `secondary`,
        },
      ],
      [
        {
          action: {
            type: `text`,
            label: `✏️ ${COMMANDS.CHANGE_PHONE.toUpperCase()}`,
          },
          color: `secondary`,
        },
      ],
      ...
      [
        {
          action: {
            type: `text`,
            label: `❌ ${COMMANDS.CANCELLATION.toUpperCase()}`,
          },
          color: `negative`,
        },
      ],
      ...
      [
        {
          action: {
            type: `text`,
            label: `➕ ${COMMANDS.ADD_PVZ_TO_DB.toUpperCase()}`,
          },
          color: `positive`,
        },
        {
          action: {
            type: `text`,
            label: `🗑️ ${COMMANDS.DELETE_PVZ_FROM_DB.toUpperCase()}`,
          },
          color: `negative`,
        },
      ],
      ...
      [
        {
          action: {
            type: `text`,
            label: `📊 ${COMMANDS.REPORT_OPENING.toUpperCase()}`,
          },
          color: `positive`,
        },
        {
          action: {
            type: `text`,
            label: `📊 ${COMMANDS.REPORT_CLOSING.toUpperCase()}`,
          },
          color: `positive`,
        },
      ],
      [
        {
          action: {
            type: `text`,
            label: `❌ ${COMMANDS.MISSING_OPENING.toUpperCase()}`,
          },
          color: `negative`,
        },
        {
          action: {
            type: `text`,
            label: `❌ ${COMMANDS.MISSING_CLOSING.toUpperCase()}`,
          },
          color: `negative`,
        },
      ],
      [
        {
          action: {
            type: `text`,
            label: `🔔 ${COMMANDS.REMIND_OPENING.toUpperCase()}`,
          },
          color: `primary`,
        },
        {
          action: {
            type: `text`,
            label: `🔔 ${COMMANDS.REMIND_CLOSING.toUpperCase()}`,
          },
          color: `primary`,
        },
      ],
    ...
    [
      {
        action: {
          type: `text`,
          label: `✅ ${COMMANDS.YES_DATA_IS_CORRECT.toUpperCase()}`,
        },
        color: `positive`,
      },
    ],
